...
// ============================================================
// The config is loaded from config.js which is NOT in GitHub
// ============================================================
...
const firebaseConfig = window.FIREBASE_CONFIG || {
    // Fallback - replace with your actual values if needed
...
console.log('✅ Firebase initialized with private config');
console.log('📁 Project:', firebaseConfig.projectId);
console.log('🔐 Config loaded from:', typeof window.FIREBASE_CONFIG !== 'undefined' ? 'config.js (private)' : 'fallback');
